...
const configuredAiRateLimit = Number(process.env.UW_AI_RATE_LIMIT || 300);
const AI_RATE_LIMIT = Number.isFinite(configuredAiRateLimit) ? Math.max(20, Math.floor(configuredAiRateLimit)) : 300;
